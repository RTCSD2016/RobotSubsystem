...
{
	this->targ_position_x = x;
	this->targ_position_y = y;
}
void RobotCommand::SetVelocity(double x, double y)
{
	this->targ_velocity_x = x;
	this->targ_velocity_y = y;
}
void RobotCommand::SetTime(double time)
{
	this->targ_time = time;
}
void RobotCommand::InitPosition(double x, double y)
{
	position_x = x;
	position_x = y;
}
void RobotCommand::InitVelocity(double x, double y)
{
	velocity_x = x;
	velocity_y = y;
}
